import {
    ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, EllipsisHorizontalIcon,
...
import selectTime from '@/app/helpers/selectTime';

function CalendarHeader() {
    const {
        goNextMonth, goPrevMonth, goToday, viewMonth, viewDay, viewWeek,
    } = useCalendarActions();
    const time = useCalendarStore(selectTime);

    const label = `${new Date(time).toLocaleString('default', {month: 'long'})} ${new Date(time).getFullYear()}`;
